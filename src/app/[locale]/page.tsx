    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link
              href="/properties"
              className="text-green-brand hover:text-green-800 text-sm font-semibold flex items-center gap-1 transition"
            >
              {t("featured.viewAll")}
            </Link>
          </div>
      ...
      <section className="message-section-bg py-20 md:py-28 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-10 left-10 w-64 h-64 bg-gold-brand rounded-full blur-3xl" />
        </div>
        <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
          <div className="inline-block mb-6">
            <div className="w-12 h-px bg-gold-brand mx-auto mb-4" />
            <h2 className="text-3xl md:text-4xl font-bold text-white">
              {t("messageSection.title")}
            </h2>
            <div className="w-12 h-px bg-gold-brand mx-auto mt-4" />
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 rounded-2xl bg-white border border-gray-100 hover:border-green-brand/20 hover:shadow-lg transition-all">
              <div className="w-16 h-16 bg-green-brand/10 rounded-2xl flex items-center justify-center mx-auto mb-5">
                <svg className="w-8 h-8 text-green-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor">
